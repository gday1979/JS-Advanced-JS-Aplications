function validate() {
  document.getElementById("company").addEventListener("change", () => {
    // Добавяме слушател за company elementa
  ...
  function onClick(event) {
    // Създаваме функция, която да отговаря за това
    ...
    if (
      ...
      // Проверяваме дали е грешен или дали не съвпадат паролите
    ...
    if (checkbox.checked) {
      ...
      if (!companyPattern.test(companyId.value) || companyId.value < 1000) {
        // Ако не минава регекса или числото е под 1000
