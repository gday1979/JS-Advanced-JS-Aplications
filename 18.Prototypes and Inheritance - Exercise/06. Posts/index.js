function posts() {
  class Post {
    ...
    constructor(title, content) {
      // Конструктора получава title и content като параметри
  ...
  class SocialMediaPost extends Post {
    // Създаваме клас SocialMediaPost, който extendva класа Post
    constructor(title, content, likes, dislikes) {
      // Конструктора получава title,content,likes и dislikes като параметри
  ...
  class BlogPost extends Post {
    // Създаваме клас BlogPost, който extendva класа Post
    constructor(title, content, views) {
      // Конструктора получава title,content и views като параметри
      super(title, content); // Наследяваме title и content от класа Post
