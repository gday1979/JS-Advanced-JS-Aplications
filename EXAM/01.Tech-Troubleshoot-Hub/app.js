...
function solution() {
 ...
 const previewUlElemnent=document.querySelector('.preview-list');
 ...
 const resolvedUlElement=document.querySelector('.resolved-list');
  ...
  function add(e){
    ...
    previewUlElemnent.appendChild(liElement);
    ...
    function edit(){
       ...
       function onContinue(){
          ...
          let resolveBtnElement=document.createElement('button');
          ...
          liElement.remove();
          resolveBtnElement.addEventListener('click', onresolve);
          ...
          function onresolve(){
           ...
           liElementResolve.appendChild(clearBtnElement);

           resolvedUlElement.appendChild(liElementResolve);
